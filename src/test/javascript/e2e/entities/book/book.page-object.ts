...
export class BookUpdatePage {
  ...
  bookImageInput = element(by.id('file_bookImage'));
  ...
  async setBookImageInput(bookImage) {
    await this.bookImageInput.sendKeys(bookImage);
  }

  async getBookImageInput() {
    return await this.bookImageInput.getAttribute('value');
  }
